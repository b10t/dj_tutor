...
from .models import SuperRubric, SubrRubric
...
class SubRibricInline(admin.TabularInline):
    model = SubrRubric

class SuperRubricAdmin(admin.ModelAdmin):
    exclude = ('super_rubric',)
    inlines = (SubRibricInline,)
...
admin.site.register(SubrRubric, SubRubricAdmin)
